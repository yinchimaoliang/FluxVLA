...
Defaults follow the official GR00T N1.7 LIBERO fine-tuning recipe. The
processor/statistics metadata defaults to the matching official LIBERO
checkpoint because the base checkpoint does not contain ``libero_sim`` stats.
Override ``N17_PROCESSOR_META`` after generating native dataset statistics.
"""
