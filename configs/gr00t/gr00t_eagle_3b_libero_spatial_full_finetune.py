...
model = dict(
    ...
    vla_head=dict(
        ...
        # Match the released LIBERO-Spatial checkpoint training contract.
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        dataset_statistics_path=('configs/gr00t/statistics/'
                                 'gr00t_eagle_3b_libero_spatial_legacy.json'),
        ...
        datasets=dict(
            ...
            'datasets/libero_spatial_no_noops_lerobotv2.1_old',  # noqa: E501
            transforms=[
                dict(
